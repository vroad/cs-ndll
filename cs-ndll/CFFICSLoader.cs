...
namespace cs
{
    class CFFICSLoader
    {
        ...
        private static int cs_val_type(IntPtr inArg1)
        {
            ...
            else if (NDLLFunction.ArrayType.Equals(arg1))
                return (int)hxValueType.valtArray;
            else if (NDLLFunction.FunctionType.Equals(arg1))
            ...
            else if (NDLLFunction.ObjectType.Equals(arg1))
        ...
        {
            CSAbstract handle = new CSAbstract(arg1, arg2);
            return CSHandleContainer.GetCurrent().CreateGCHandle(handle);
        }
        ...
        private static IntPtr cs_val_array_int(IntPtr inArg1)
        {
            ...
            if (NDLLFunction.ArrayType.Equals(value))
            {
                int length = (int)NDLLFunction.ArrayLengthInfo.GetValue(value);
                Array nativeArray = (Array)NDLLFunction.NativeArrayInfo.GetValue(value);
                IntPtr intArr = CSHandleContainer.GetCurrent().AllocateMemory(sizeof(int) * length);
                Marshal.Copy((int[])nativeArray, 0, intArr, length);
        ...
        private static int cs_val_array_size(IntPtr inArg1)
        {
            ...
            if (NDLLFunction.ArrayType.Equals(arg1))
                return (int)NDLLFunction.ArrayLengthInfo.GetValue(arg1);
        ...
        private static IntPtr cs_val_array_i(IntPtr inArg1, int arg2)
        {
            ...
            if (NDLLFunction.ArrayType.Equals(arg1))
            {
                Array nativeArray = (Array)NDLLFunction.NativeArrayInfo.GetValue(arg1);
                return CSHandleContainer.GetCurrent().CreateGCHandle(nativeArray);
            }
        ...
        private static void cs_alloc_field(IntPtr inArg1, int arg2, IntPtr inArg3)
        {
            ...
            object[] arguments = { arg1, field, arg3 };
            NDLLFunction.ReflectSetFieldInfo.Invoke(null, arguments);
        }
        ...
        private static IntPtr cs_val_field(IntPtr inArg1, int arg2)
        {
            ...
            object[] arguments = { arg1, field };
            return container.CreateGCHandle(NDLLFunction.ReflectFieldInfo.Invoke(null, arguments));
        }
        ...
        private static IntPtr cs_val_call0(IntPtr inArg1)
        {
            ...
            object result = NDLLFunction.FunctionInvokeInfo.Invoke(arg1, arguments);
            return CSHandleContainer.GetCurrent().CreateGCHandle(result);
        }

        private static IntPtr cs_alloc_empty_object()
        {
            Object hxObject = NDLLFunction.ObjectCtorInfo.Invoke(null);
            return CSHandleContainer.GetCurrent().CreateGCHandle(hxObject);
        }
